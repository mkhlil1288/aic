...
if ( ! function_exists('get_pages')){
	function get_pages() 
	{
		$pages = \App\Models\Page::where("page_status","publish")->get();
	    return $pages;
	}
}
...
if ( ! function_exists('get_posts')){
	...
	{
		$posts = \App\Models\Post::where("post_status","publish")
...
if ( ! function_exists('get_events')){
	...
	{
		$events = \App\Models\Event::limit($limit)
						->orderBy("id","desc")->get();
	    return $events;
	}
}
...
if( !function_exists('do_shortcode') ){
	function do_shortcode($shortcode, $atts){
		global $shortcodes;
