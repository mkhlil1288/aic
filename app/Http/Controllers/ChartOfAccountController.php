...
class ChartOfAccountController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		if(! $request->ajax()){
           return redirect('chart_of_accounts/create')->with('success', _lang('Information has been added sucessfully'));
        }else{
		   return response()->json(['result'=>'success','action'=>'store','message'=>_lang('Information has been added sucessfully'),'data'=>$chartofaccount]);
		}
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('chart_of_accounts')->with('success', _lang('Information has been updated sucessfully'));
        }else{
		   return response()->json(['result'=>'success','action'=>'update', 'message'=>_lang('Information has been updated sucessfully'),'data'=>$chartofaccount]);
		}
    ...
    public function destroy($id)
    {
        ...
        return redirect('chart_of_accounts')->with('success',_lang('Information has been deleted sucessfully'));
    }
}