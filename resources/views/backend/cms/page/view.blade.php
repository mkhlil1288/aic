...
<div class="row">
	...
	<div class="panel-body">
	  ...
	  <table class="table table-bordered">
		<tr><td>{{ _lang('Featured Image') }}</td><td><img src="{{ $page->featured_image !="" ? asset('uploads/media/'.$page->featured_image) : asset('uploads/no_image.jpg') }}" style="max-width:200px;"></td></tr>
