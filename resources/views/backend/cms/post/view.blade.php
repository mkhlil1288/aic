		...
		<div class="tab-content params-panel">
			...
			<div id="english" class="tab-pane fade in active">
			  <table class="table table-bordered">
				<tr><td>{{ _lang('Featured Image') }}</td><td><img src="{{ $post->featured_image !="" ? asset('uploads/media/'.$post->featured_image) : asset('uploads/no_image.jpg') }}" style="max-width:200px;"></td></tr>
