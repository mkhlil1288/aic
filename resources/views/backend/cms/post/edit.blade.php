...
@section('content')
<div class="row">
<form method="post" class="validate" autocomplete="off" action="{{action('App\Http\Controllers\PostController@update', $id)}}" enctype="multipart/form-data">	
	<div class="col-md-8">
		   ...
		   <div class="col-md-12">
			...
			<div class="col-md-12">
			  <div class="form-group">
				...
				<input type="file" class="dropify" name="featured_image" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-show-remove="false" data-default-file="{{ asset('uploads/media/'.$post->featured_image) }}">
			  </div>
			</div>
		</div>
	</div>
