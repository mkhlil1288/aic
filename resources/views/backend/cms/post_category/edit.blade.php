	...
	<div class="col-md-6">
		<div class="panel panel-default">
			...
			<span class="panel-title">{{ _lang('Update Post Category') }}</span>			
				<form action="{{action('App\Http\Controllers\PostCategoryController@destroy', $postcategory->id)}}" method="post">
					{{ csrf_field() }}
			...
			<form method="post" autocomplete="off" action="{{action('App\Http\Controllers\PostCategoryController@update', $id)}}" enctype="multipart/form-data">
				{{ csrf_field()}}
