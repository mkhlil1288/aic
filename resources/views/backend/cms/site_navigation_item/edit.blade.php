	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<form action="{{ action('App\Http\Controllers\NavigationItemController@destroy', $id) }}" method="post">
					{{ csrf_field() }}
			...
			<form method="post" autocomplete="off" action="{{action('App\Http\Controllers\NavigationItemController@update', $id)}}">
				{{ csrf_field()}}
