		...
		<div class="panel panel-default no-export">
			...
			<tbody>
			  ...
			  <tr id="row_{{ $sitenavigation->id }}">
				...
				<td>
				  <form action="{{ action('App\Http\Controllers\SiteNavigationController@destroy', $sitenavigation['id']) }}" method="post">
					<a href="{{ action('App\Http\Controllers\SiteNavigationController@edit', $sitenavigation['id']) }}" data-title="{{ _lang('Update Site Navigation') }}" class="btn btn-warning btn-sm ajax-modal">{{ _lang('Edit') }}</a>
