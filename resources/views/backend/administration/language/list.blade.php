			 ...
			 <table class="table table-bordered data-table">
				...
				<tbody>
				  ...
				  <tr>
					...
					<td>
						<a href="{{ action('App\Http\Controllers\LanguageController@edit', $language) }}" class="btn btn-info btn-sm">{{ _lang('Edit Translation') }}</a>
					</td>	
					<td>
					    <form action="{{action('App\Http\Controllers\LanguageController@destroy', $language)}}" method="post">
						   {{ csrf_field() }}
