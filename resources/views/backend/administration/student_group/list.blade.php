		...
		<div class="panel panel-default">
			...
			<tbody>
			  ...
			  <tr id="row_{{ $studentgroup->id }}">
				...
				<td>
				  <form action="{{action('App\Http\Controllers\StudentGroupController@destroy', $studentgroup['id'])}}" method="post">
					<a href="{{action('App\Http\Controllers\StudentGroupController@edit', $studentgroup['id'])}}" data-title="{{ _lang('Update Student Group') }}" class="btn btn-warning btn-sm ajax-modal">{{ _lang('Edit') }}</a>
					{{ csrf_field() }}
