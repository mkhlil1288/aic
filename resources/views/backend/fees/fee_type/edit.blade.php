...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">{{ _lang('Update Fee Type') }}</div>

			<div class="panel-body">
			<form method="post" class="validate" autocomplete="off" action="{{action('App\Http\Controllers\FeeTypeController@update', $id)}}" enctype="multipart/form-data">
				{{ csrf_field()}}
