					...
					<tr>
						...
						<td><li class="dropdown" style="display: inline;">
							...
							<ul class="dropdown-menu">
								@if($assignment->file)
								<li><a href="{{ asset('uploads/files/assignments/'.$assignment->file) }}">{{$assignment->file}}</a></li>
								@endif
								@if($assignment->file_2) 
								<li><a href="{{ asset('uploads/files/assignments/'.$assignment->file_2) }}">{{$assignment->file_2}}</a></li>
								@endif
								@if($assignment->file_3) 
								<li><a href="{{ asset('uploads/files/assignments/'.$assignment->file_3) }}">{{$assignment->file_3}}</a></li>
								@endif
								@if($assignment->file_4) 
								<li><a href="{{ asset('uploads/files/assignments/'.$assignment->file_4) }}">{{$assignment->file_4}}</a></li>
								@endif
							</ul>
						</li>
					</td>
